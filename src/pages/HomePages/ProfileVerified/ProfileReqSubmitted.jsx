  ...
  return (
    <AppLayout>
      <div className="verified-page-container">
        ...
        {/* Top Header */}
        <h1 className="verified-header-text fade-in">Submitted</h1>
        ...
        <div className="verified-card-wrapper">
          <div className="verified-card slide-up">
            ...
            <h2 className="verified-title">Your Profile Request Submitted</h2>
...
export default ProfileReqSubmitted