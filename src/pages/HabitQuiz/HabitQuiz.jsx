...
const HabitQuiz = () => {
    ...
    const questions = [
        {
            id: 1,
            title: "I feel most balanced when my partner and I have similar daily habits and energy levels.",
        },
        {
            id: 2,
            title: "If I had to choose between spending time on my goals or my relationship, I'd usually choose my goals.",
        }
    ];
